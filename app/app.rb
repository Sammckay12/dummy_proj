...
class MakersBnB < Sinatra::Base
  ...
  set :sessions, user_id: nil
    ...
    owner = User.create(email: 'owner_email', name: 'owner_name')
    renter = User.create(email: 'renter_email', name: 'renter_name')
    renter_2 = User.create(email: 'renter2_email', name: 'renter2_name')
  ...
  #    p @listings
  #   #  @requests = Request.all(listing_id: => user_id: session[:user_id] )
  #   #  p @requests
  #   # p @listings
  #   erb :user_view
  # end
